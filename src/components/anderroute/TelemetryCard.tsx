...
import type { Shipment, Telemetry } from "@/types/logistics";
...
export function TelemetryCard({ telemetry, shipment }: TelemetryCardProps) {
  return (
    <div className="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-slate-200">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Ring value={telemetry.fuel_percent} label="Fuel" unit="%" color="rgb(20,184,166)" />
        <Ring value={telemetry.battery_percent} label="Battery" unit="%" color="rgb(249,115,22)" />
        <Ring value={telemetry.signal_percent} label="Signal" unit="%" color="rgb(56,189,248)" />
      </div>
