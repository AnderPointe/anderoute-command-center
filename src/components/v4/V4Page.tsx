      ...
      <div className="space-y-5">
        ...
        <header className="space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            <Badge variant="outline" className="border-sky-500/40 text-sky-300">Phase 21</Badge>
            <Badge variant="outline" className="border-white/15 text-muted-foreground">V4 enterprise launch</Badge>
          </div>
