...
function Page() {
  const c = H.useRevenueDurabilityControls();
  return (
    <V14Page icon={<ShieldCheck className="size-6 text-cyan-300" />} title="Revenue Durability Control Framework" blurb="Control matrix, owner board, testing calendar, exception queue.">
      <ScoreCard label="Revenue control score" value={c.score} tone="emerald" />
...
export const Route = createFileRoute("/v14/revenue-controls")({
  head: () => ({ meta: [{ title: "Revenue Controls · V14" }] }),
  component: Page,
});
