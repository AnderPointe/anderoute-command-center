...
function Page() {
  return (
    <V1Page
      ...
      title="Post-Pilot Roadmap"
      blurb="V1 ships now. V1.1, V1.5, V2, and Enterprise outline the sequenced bets that follow. Enterprise items stay deferred."
    >
        ...
        {ORDER.map((rel) => {
          ...
          return (
            <StatTile
              ...
              tone={rel === "V1" ? "info" : rel === "Enterprise" ? "default" : "default"}
            />
          );
        })}
      </div>
