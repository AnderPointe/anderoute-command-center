...
export const useCommercialOperatingMaturity     = () => ({ axes: M.V115_COMMERCIAL_OPERATING });
export const useStrategicCustomerExpansion      = () => ({ summary: M.V115_STRATEGIC_EXPANSION, signals: M.V115_EXPANSION_INTELLIGENCE });
...
export const useRetentionRisk                   = () => ({ rows: M.V115_RETENTION_RISK });
export const usePartnerMonetization             = () => ({ summary: M.V115_PARTNER_MONETIZATION, partners: M.V115_PARTNER_REVENUE_OPS });
export const useCapitalReadyRevenueGov          = () => ({ axes: M.V115_CAPITAL_READY_REVENUE });
export const usePricingOptimization             = () => ({ policies: M.V115_PRICING_OPTIMIZATION });
export const usePackagingOptimization           = () => ({ skus: M.V115_PACKAGING_OPTIMIZATION });
export const useDealDeskDiscipline              = () => ({ summary: M.V115_DEAL_DESK_DISCIPLINE });
export const useEnterpriseDealExecution         = () => ({ stages: M.V115_ENTERPRISE_DEAL_EXECUTION });
export const useTrustProcurementAccel           = () => ({ summary: M.V115_PROCUREMENT_ACCEL });
export const useSalesEngineeringScale           = () => ({ areas: M.V115_SE_SCALE });
...
export const useBoardCommercialReport           = () => ({ sections: M.V115_BOARD_COMMERCIAL });
export const useLongTermRevenueRoadmap          = () => ({ items: M.V115_ROADMAP });
export const useReportsV115                     = () => ({ reports: M.V115_REPORTS });
